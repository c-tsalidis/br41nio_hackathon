...
{
	public enum SpawnMode { Random, Point, InwardCircle, RandomCircle, BottomMiddle }
	...
	void Init()
	{
		...
		for (int i = 0; i < agents.Length; i++)
		{
			...
			else if(settings.spawnMode == SpawnMode.BottomMiddle)
            {
				startPos = new Vector2(displayTexture.width/2, 0);
				angle = 90;
			}
